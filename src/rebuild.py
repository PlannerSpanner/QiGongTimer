...
build(os.path.join(OUT,'pregnancy-stretch.html'),'d_stretch.js',open('x_stretch.js',encoding='utf-8').read(),
...
build(os.path.join(OUT,'pregnancy-movement.html'),'d_birth.js',open('x_birth.js',encoding='utf-8').read(),
